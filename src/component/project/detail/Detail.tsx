...
import { Body1, Body1Bold, Header1, Header2, Inner, Section } from '../../emotion/GlobalStyle';
import { ImageBox, ProjectLinkButton, TeamInfoBox } from './component';
      ...
      <Section gap="4">
        ...
        <ContainerComponent>
          ...
          >
            ...
            <Body1>새롭고 달라진 금융 서비스를 만나보세요</Body1>
          </div>
        </ContainerComponent>
        <ContainerComponent>
        ...
        <ContainerComponent>
          ...
          >
            <Body1>
              ...
              imBody1act를 하다 보니 전체 디자인에 통일성이 결여된 상황이 발생했습니다. 컴포넌트의
            ...
            <Body1>
              <Body1Bold>조직 개편</Body1Bold>
              다른 애자일 조직도 분명 유사한 어려움이 있었을 것이라 생각해 찾던 중, 스포티파이가
              유사한 문제를 경험하고 해결했음을 알게 되었습니다.
            </Body1>
            <Body1>
              <Body1Bold>디자인 개편</Body1Bold>
              토스 팀은 앞서 언급했던 것처럼, Focus on imBody1act를 고민하며 큰 효과를 낼 수 있는
